                    ...
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a href="https://http://localhost:8080" target="_blank">
                                <h1 class="text-primary mb-0">ThinkPro</h1>
                                <p class="text-secondary mb-0">@nhom25</p>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Author:Nhóm 25</p>
                            <p>Website: <a href="https://http://localhost:8080" target="_blank"> nhom25.vn</a></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="https://http://localhost:8080" target="_blank"><i
                                    class="fas fa-copyright text-light me-2"></i>Nhóm 25</a>, All right
                            reserved.</span>
                    </div>
